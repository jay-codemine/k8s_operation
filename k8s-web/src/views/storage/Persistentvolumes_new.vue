      ...
      <table class="resource-table">
        ...
        <tbody>
          <tr v-for="pv in paginatedPVs" :key="pv.name" :class="{ 'row-selected': isPVSelected(pv) }">
            ...
            <td>
              <span class="status-indicator" :class="pv.status.toLowerCase()">
                {{ pv.status }}
              </span>
            </td>
            <td>
            ...
            <td>
              <div class="action-icons">
                ...
                <button class="action-btn icon-only" @click="downloadYaml(pv)" title="下载YAML">
                  💾
                </button>
                <button 
          ...
          <div class="detail-section">
            ...
            <div class="detail-grid">
              ...
              <div class="detail-item">
                ...
                <span class="status-indicator" :class="selectedPV?.status.toLowerCase()">
                  {{ selectedPV?.status }}
                </span>
              </div>
              <div class="detail-item">
