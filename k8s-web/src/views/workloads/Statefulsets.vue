...
.resource-table { width: 100%; border-collapse: collapse; min-width: 1400px; /* 确保表格有足够宽度避免挤压 */ table-layout: auto; /* 根据内容自动调整列宽 */ }
...
.image-text { display: flex; align-items: center; gap: 8px; }
...
.selector-tag { background-color: rgba(50, 108, 229, 0.1); color: #326ce5; padding: 2px 6px; border-radius: 4px; font-size: 11px; font-weight: 500; }
