...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/k8s/cicd/approval/feishu-callback": {
            "get": {
        ...
        "/api/v1/k8s/cicd/pipeline/build-stats": {
            "get": {
        ...
        "/api/v1/k8s/cicd/pipeline/jenkins-config": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.CicdReleaseBatchRetryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/k8s/cicd/release/batch-rollback": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.CicdReleaseBatchRollbackRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/k8s/cicd/release/history": {
            "get": {
        ...
        "/api/v1/k8s/cicd/release/stats-enhanced": {
            "get": {
        ...
        "/api/v1/k8s/cicd/release/sync-from-pipeline": {
            "post": {
        ...
        "/api/v1/k8s/cluster/batch-delete": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.K8sClusterBatchDeleteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/k8s/rbac/serviceaccount/events": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/k8s/rbac/serviceaccount/yaml": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.LDAPConfigResponse"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.LDAPSyncResult"
                        }
                    }
                }
            }
        ...
        "/api/v1/platform/license/activate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "License 文本",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.activateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/license.Status"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/platform/license/status": {
            "get": {
    ...
    "definitions": {
        "license.Status": {
            ...
            "properties": {
                ...
                "machine_id": {
                    "description": "本机机器码（用于向供应商申请 License）",
                    "type": "string"
                },
                "reason": {
                    "description": "未授权原因（未激活/已过期/机器码不匹配等）",
                    "type": "string"
                }
            }
        },
        ...
        "requests.CicdReleaseBatchRetryRequest": {
            "type": "object",
            "properties": {
                "ids": {
                    "type": "array",
        ...
        "requests.CicdReleaseBatchRollbackRequest": {
            "type": "object",
            "properties": {
                "ids": {
                    "type": "array",
        ...
        "requests.CicdReleaseCreateRequest": {
            ...
            "properties": {
                ...
                "pipeline_id": {
                    "description": "模板化发布：传入 pipeline_id 后自动继承流水线的部署配置，以下字段均可省略",
                    "type": "integer"
                },
                "request_id": {
        ...
        "requests.K8sClusterBatchDeleteRequest": {
            "type": "object",
            "properties": {
                "ids": {
                    "type": "array",
        ...
        "services.LDAPConfigResponse": {
            ...
            "properties": {
                ...
                "group_role_mapping": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/setting.LDAPGroupRoleMapping"
                    }
                },
                "host": {
                    "type": "string"
        ...
        "services.PlatformHealthStatus": {
            ...
            "properties": {
                ...
                "online_users": {
                    "description": "当前在线用户数（15分钟内活跃）",
                    "type": "string"
                },
                "panics": {
                    "description": "Panic恢复次数",
                    "type": "integer"
                },
                "status": {
        ...
        "setting.LDAPGroupRoleMapping": {
            "type": "object",
            "properties": {
                "cicdaccess": {
                    "description": "发布域权限级别: none/read/write/admin",
                    "type": "string"
                },
                "clusterAccess": {
                    "description": "集群域权限级别: none/read/write/admin",
                    "type": "string"
                },
                "ldapgroup": {
                    "description": "LDAP 组名（cn 值）",
                    "type": "string"
                },
                "platformRole": {
                    "description": "平台角色标识",
