...
func (s *MonitorCRUDService) ListSilenceRules(ctx context.Context, req SilenceRuleListReq) (*SilenceRuleListResp, error) {
	...
	var total int64
	db.Model(&SilenceRule{}).Count(&total)
...
// GetSilenceRule 详情
func (s *MonitorCRUDService) GetSilenceRule(ctx context.Context, id int64) (*SilenceRule, error) {
...
func (s *MonitorCRUDService) CreateSilenceRule(ctx context.Context, rule *SilenceRule) error {
	return s.db.WithContext(ctx).Create(rule).Error
}

// UpdateSilenceRule 更新
func (s *MonitorCRUDService) UpdateSilenceRule(ctx context.Context, rule *SilenceRule) error {
...
func (s *MonitorCRUDService) DeleteSilenceRule(ctx context.Context, id int64) error {
	return s.db.WithContext(ctx).Model(&SilenceRule{}).
...
func (s *MonitorCRUDService) ListInhibitRules(ctx context.Context, req InhibitRuleListReq) (*InhibitRuleListResp, error) {
	...
	var total int64
	db.Model(&InhibitRule{}).Count(&total)
...
func (s *MonitorCRUDService) CreateInhibitRule(ctx context.Context, rule *InhibitRule) error {
	return s.db.WithContext(ctx).Create(rule).Error
}

// UpdateInhibitRule 更新
func (s *MonitorCRUDService) UpdateInhibitRule(ctx context.Context, rule *InhibitRule) error {
	return s.db.WithContext(ctx).Model(rule).
		Where("id = ? AND is_del = 0", rule.ID).
		Updates(map[string]interface{}{
			"name":            rule.Name,
...
func (s *MonitorCRUDService) DeleteInhibitRule(ctx context.Context, id int64) error {
	return s.db.WithContext(ctx).Model(&InhibitRule{}).
		Where("id = ? AND is_del = 0", id).
		Update("is_del", 1).Error
}
...
type AggregateRuleListResp struct {
	Total int64                           `json:"total"`
	Items []AggregateRule   `json:"items"`
}
...
func (s *MonitorCRUDService) ListAggregateRules(ctx context.Context, req AggregateRuleListReq) (*AggregateRuleListResp, error) {
	...
	var total int64
	db.Model(&AggregateRule{}).Count(&total)
...
func (s *MonitorCRUDService) CreateAggregateRule(ctx context.Context, rule *AggregateRule) error {
	return s.db.WithContext(ctx).Create(rule).Error
}

// UpdateAggregateRule 更新
func (s *MonitorCRUDService) UpdateAggregateRule(ctx context.Context, rule *AggregateRule) error {
	return s.db.WithContext(ctx).Model(rule).
		Where("id = ? AND is_del = 0", rule.ID).
		Updates(map[string]interface{}{
			"name":            rule.Name,
...
func (s *MonitorCRUDService) DeleteAggregateRule(ctx context.Context, id int64) error {
	return s.db.WithContext(ctx).Model(&AggregateRule{}).
		Where("id = ? AND is_del = 0", id).
		Update("is_del", 1).Error
}
...
// UpdateSilenceRuleFields 部分更新静默规则字段
func (s *MonitorCRUDService) UpdateSilenceRuleFields(ctx context.Context, id int64, updates map[string]interface{}) error {
	return s.db.WithContext(ctx).Model(&SilenceRule{}).Where("id = ? AND is_del = 0", id).Updates(updates).Error
}

// ListDeploySilences 列出发布静默规则
func (s *MonitorCRUDService) ListDeploySilences(ctx context.Context, pipelineID int64) ([]*SilenceRule, error) {
	now := time.Now().Unix()
...
// DeactivateExpiredSilences 停用过期的发布静默规则
func (s *MonitorCRUDService) DeactivateExpiredSilences(ctx context.Context) (int64, error) {
	now := time.Now().Unix()
	result := s.db.WithContext(ctx).Model(&SilenceRule{}).
