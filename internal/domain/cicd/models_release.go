...
const (
	...
	CicdReleaseStatusAwaitingApproval = "AwaitingApproval"
	...
	CicdReleaseStatusRollback         = "Rollback"
)
...
type CicdRelease struct {
	...
	Concurrency uint32 `gorm:"column:concurrency" json:"concurrency"`
	...
	SourceEnv   string `gorm:"column:source_env;size:32" json:"source_env"`
	SourceRunID int64  `gorm:"column:source_run_id" json:"source_run_id"`
...
// CicdReleaseWithDeployMode 带部署模式的发布单
